...
struct MockData {
   ...
   static let sampleFramework = Framework(id: UUID.init(), name: "ARKit",
                                           imageName: "arkit",
    ...
    static let frameworks = [
      Framework(id: UUID.init(), name: "App Clips",
                  imageName: "app-clip",
      ...
      Framework(id: UUID.init(), name: "ARKit",
                  imageName: "arkit",
                  urlString: "https://developer.apple.com/augmented-reality/arkit",
                  description: "ARKit 4 introduces a brand-new Depth API, creating a new way to access the detailed depth information gathered by the LiDAR Scanner on iPhone 12 Pro, iPhone 12 Pro Max, and iPad Pro.\n\nLocation Anchors leverages the higher-resolution data in Apple Maps to place AR experiences at a specific point in the world in your iPhone and iPad apps. And support for face tracking extends to all devices with the Apple Neural Engine and a front-facing camera, so even more users can experience the joy of AR in photos and videos."),
        
      Framework(id: UUID.init(), name: "CarPlay",
                  imageName: "carplay",
      ...
      Framework(id: UUID.init(), name: "Catalyst",
                  imageName: "catalyst",
      ...
      Framework(id: UUID.init(), name: "ClassKit",
                  imageName: "classkit",
      ...
      Framework(id: UUID.init(), name: "CloudKit",
                  imageName: "cloudkit",
      ...
      Framework(id: UUID.init(), name: "Core ML",
                  imageName: "coreml",
      ...
      Framework(id: UUID.init(), name: "HealthKit",
                  imageName: "healthkit",
      ...
      Framework(id: UUID.init(), name: "Metal",
                  imageName: "metal",
      ...
      Framework(id: UUID.init(), name: "SF Symbols",
      ...
      Framework(id: UUID.init(), name: "SiriKit",
                  imageName: "sirikit",
      ...
      Framework(id: UUID.init(), name: "SpriteKit",
                  imageName: "spritekit",
      ...
      Framework(id: UUID.init(), name: "SwiftUI",
                  imageName: "swiftui",
      ...
      Framework(id: UUID.init(), name: "Test Flight",
      ...
      Framework(id: UUID.init(), name: "Wallet",
                  imageName: "wallet",
      ...
      Framework(id: UUID.init(), name: "WidgetKit",
                  imageName: "widgetkit",
